      ...
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          {error ? (
            ...
            <>
              ...
              <CardDescription>
                This lets {clientName} read and act on your FoodShare donations and requests as you.
              </CardDescription>
            </>
          )}
        </CardHeader>
        {details && !error && (
          <CardContent className="flex gap-3">
            <Button className="flex-1 bg-gradient-hero" disabled={busy} onClick={() => decide(true)}>
              Approve
            </Button>
